...
import org.codingstyle.TestUtils;
...
import static org.codingstyle.checkstyle.CheckStyleTestUtils.assertHasCheckstyleErrors;
...
public class CheckstyleIndentationWriterTest {
    ...
    @Before
    public void setUp() {
        this.style = TestUtils.generateStyle();
    }
