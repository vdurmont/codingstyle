...
public class JaxbConfigProcessor<T> implements ConfigProcessor<T> {
    ...
    public JaxbConfigProcessor(Class<T> targetClass) {
        ...
        try {
            ...
            throw new CodingStyleException("Unable to initialize the reader.", e);
        }
    }
    ...
    public T readFromStream(InputStream stream) {
        try {
            ...
            throw new CodingStyleException("An error occurred while reading stream.", e);
        }
    }
    ...
    public void writeToStream(T input, OutputStream stream) {
        try {
            ...
            throw new CodingStyleException("An error occurred while writing the object: " + input + " to the stream.", e);
        }
    }
